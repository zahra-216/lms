...
<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-nav">
        ...
        <a href="{{ route('admin.gate-log.index') }}"><i class="bi bi-door-open"></i> Gate Log</a>
        <a href="{{ route('admin.gate-devices.index') }}"><i class="bi bi-hdd-network"></i> Gate Devices</a>
