...
<body>
<div class="container">
    <a href="{{ route('admin.subjects.quizzes.show', ['subject' => $subject->id, 'quiz' => $quiz->id]) }}" class="back-btn">
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            <form action="{{ route('admin.subjects.quizzes.submissions.saveGrades', ['subject' => $subject->id, 'quiz' => $quiz->id, 'submission' => $submission->id]) }}" method="POST">
                @csrf
