    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="section-card">
                ...
                <form action="{{ route('admin.subjects.quizzes.update', ['subject' => $subject->id, 'quiz' => $quiz->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
        ...
        <div class="col-lg-8">
                    ...
                    <div class="question-item">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <form action="{{ route('admin.subjects.quizzes.questions.destroy', ['subject' => $subject->id, 'quiz' => $quiz->id, 'question' => $question->id]) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
            ...
            <div class="section-card">
                ...
                <form action="{{ route('admin.subjects.quizzes.questions.store', ['subject' => $subject->id, 'quiz' => $quiz->id]) }}" method="POST">
                    @csrf
...
<div class="modal fade" id="editQuestion{{ $question->id }}" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="border-radius:14px; border:none;">
            ...
            <form action="{{ route('admin.subjects.quizzes.questions.update', ['subject' => $subject->id, 'quiz' => $quiz->id, 'question' => $question->id]) }}" method="POST">
                @csrf
                @method('PUT')
