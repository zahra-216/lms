...
<div class="container">
    ...
    <div class="page-header">
        ...
        <a href="{{ route('admin.subjects.quizzes.create', $subject->id) }}" class="btn-navy">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="quiz-card">
                    ...
                    <div class="quiz-actions">
                        <a href="{{ route('admin.subjects.quizzes.show', ['subject' => $subject->id, 'quiz' => $quiz->id]) }}" class="btn-soft">
                            <i class="bi bi-eye"></i> View
                        </a>
                        @if($quiz->canBeEdited())
                        <a href="{{ route('admin.subjects.quizzes.edit', ['subject' => $subject->id, 'quiz' => $quiz->id]) }}" class="btn-soft">
    ...
    @else
        <div class="empty-box">
            ...
            <p class="mt-3 mb-0">No quizzes yet. <a href="{{ route('admin.subjects.quizzes.create', $subject->id) }}" style="color:#012147; font-weight:600;">Create one now</a></p>
        </div>
    @endif
</div>
