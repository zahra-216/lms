...
<div class="container">
    ...
    <div class="card-box">
            <div class="text-center mb-4" style="padding-bottom:20px; border-bottom:1px solid #e2e8f0;">
                <img src="{{ route('admin.students.qr', $student->id) }}" alt="QR Code" style="width:180px; border-radius:10px;">
                <div class="mt-2">
                    <a href="{{ route('admin.students.qr', $student->id) }}" download="{{ $student->registration_no }}-qr.svg" class="back-btn" style="margin:0; display:inline-flex;">
