...
<head>
    ...
    <style>
        ...
        .form-control:focus{
            border-color:#012147;
            box-shadow:0 0 0 0.15rem rgba(1,33,71,0.15);
        }
...
<button class="btn btn-primary btn-submit mt-3">
    🚀 Create Assignment
</button>
    ...
    if(id){
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(data.length === 0){
                    $('#note_id').append('<option>No Notes Found</option>');
                    return;
                }
