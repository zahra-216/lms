...
<div class="container">
        ...
        @if($subject->assignments->count())
            @foreach($subject->assignments as $assignment)
                <div class="assignment-row">
                    ...
                    <a href="{{ route('admin.marks.create', $assignment->id) }}" class="btn btn-sm btn-navy">
                        Enter / Edit Marks
                    </a>
                </div>
            @endforeach
    ...
    <div class="card-box">
        ...
        @if($students->count())
        <form method="POST" action="{{ route('admin.subjects.grades.update', $subject->id) }}" id="marksForm">
            @csrf
