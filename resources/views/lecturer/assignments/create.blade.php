    ...
    <div class="card-box">
        <form action="{{ route('lecturer.assignments.store', $subject->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="total_points" class="form-control" min="0" value="{{ old('total_points') }}" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="late_penalty" class="form-control" min="0" max="100" value="{{ old('late_penalty') }}">
            </div>
