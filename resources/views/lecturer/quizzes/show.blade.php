    ...
    <div class="row g-3 mb-3">
        <div class="col-lg-3 col-md-6">
            <div class="card-box">
                ...
                @endif
                @if($quiz->canBeEdited())
                <a href="{{ route('lecturer.quizzes.edit', ['subject' => $subject->id, 'quiz' => $quiz->id]) }}" class="btn-navy mt-3">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card-box">
                ...
                @if($quiz->canBeEdited())
                <a href="{{ route('lecturer.quizzes.edit', ['subject' => $subject->id, 'quiz' => $quiz->id]) }}" class="btn-navy mb-2">
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('lecturer.quizzes.submissions.grade', ['subject' => $subject->id, 'quiz' => $quiz->id, 'submission' => $submission->id]) }}" class="btn-soft">
